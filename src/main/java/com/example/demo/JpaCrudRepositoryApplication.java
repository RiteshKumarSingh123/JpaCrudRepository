...
public class JpaCrudRepositoryApplication implements WebMvcConfigurer{

	public static void main(String[] args) {
		SpringApplication.run(JpaCrudRepositoryApplication.class, args);
	}
	
	@Override
		public void addCorsMappings(CorsRegistry registry) {
		    registry.addMapping("/**")
		            .allowedOrigins("http://localhost:64092") // Specify the allowed origin (your frontend URL)
